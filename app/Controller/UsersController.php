    ...
    {			//method from online
    	...
    	{	
    		...
    		//$this->User->create();
            	...
            	$password = $this->request->data['User']['password']; //[User][password];
            	//$username =
            	//$password =
    		...
    		$result = pg_query($dbconn, "INSERT INTO newsoap.users(id, username, password) VALUES(5006, '$username', '$password');");
