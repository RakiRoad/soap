...
#Description: This file is used to scrape the information for the excel/csv file that supplies the chemicals and facilities. The data is sent to a sql file that is used to update the database.
